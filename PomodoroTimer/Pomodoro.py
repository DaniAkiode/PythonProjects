#-------------------------------------------------------------------------------
# Name:        Pomodoro.py
# Purpose:     A Pomodoro application for productivity  
#
...
class PomodoroTimer:
    ...
    def __init__(self):
        ...
        self.root.tk.call('wm', 'iconphoto', self.root._w, PhotoImage(file="C:\\Users\\danny\\PythonProjects\\PomodoroTimer\\tomato.png"))
